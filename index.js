...
// console.log(createMenuItem("wrap", 6, "lunch"))
// console.log(createMenuItem("chicken salad", 7, "lunch"))
...
Using the reviews array above do the following:
  1. Following the same format (name, rating, feedback), a
...
addNewReview("George", 1, "This place sucks!");
// console.log(reviews)

/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 5: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 
Reyna's feedback is missing! Use what you know to do the following:
  1. Add this feedback to Reyna's rating - "this place is chill with really cool people, great for getting work done on weekdays"
  2. log the reviews array to the console to check your wh really cool people, great for getting word done on the weekdays."*/
...
function getReviewByIndex(object, index) {

    return `${object[index].name} gave the restaurant a ${object[index].rating} star review, and their feedback was: ${object[index].feedback}`
}
